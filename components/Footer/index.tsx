      ...
      <div className="container mx-auto px-6 pt-12 pb-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xs font-semibold tracking-wider uppercase text-slate-400 mb-4">Calculators</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase text-slate-400 mb-4">Company</h3>
