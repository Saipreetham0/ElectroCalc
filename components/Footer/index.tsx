...
//             &copy; 2024 Circuit Of Things. All rights reserved.
//           </p>
//         </div>
//       </div>
//     </footer>
...
"use client"; // If you're using any client-side interactivity like buttons
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-4">
            {["instagram", "twitter", "linkedin", "github"].map((icon, i) => (
              ...
              >
                {/* You can swap these with actual icons like <InstagramIcon /> etc. */}
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                ...
                >
                  {/* ... each icon path goes here individually ... */}
                  <path d="..." />
                </svg>
              </Button>
            ))}
