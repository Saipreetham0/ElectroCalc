        ...
        <>
            ...
            <section className="border-b border-slate-200 dark:border-slate-800 bg-[#0a0f1a]">
                <div className="container mx-auto max-w-5xl px-6 pt-20 pb-24 text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.1] mb-5">
                        Free Online Electronics<br />
                        <span className="text-[#1C61E7]">Calculators & Tools</span>
                    </h1>

                    <p className="max-w-2xl mx-auto text-lg sm:text-xl text-slate-400 mb-8 leading-relaxed">
                        {calculators.length} professional-grade electronics calculators — Ohm&apos;s Law, resistor color codes, voltage dividers, LED resistors, wire gauges, inverter sizing, and more. Instant results, always free.
                    </p>
            ...
            <section className="border-t border-slate-200 dark:border-slate-800 py-16 px-6">
                <div className="container mx-auto max-w-3xl">
                    <p className="text-sm font-semibold tracking-wider uppercase text-[#1C61E7] mb-2 text-center">FAQ</p>
